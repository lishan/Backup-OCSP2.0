...
INSERT INTO `STREAM_EVENT` VALUES (1,'event1',1,'imsi,cell,tour_area,isAccu_tour,security_area,isAccu_security,timestamp','full_path=\'true\'',1,'{\"props\":[{\"pname\":\"userKeyIdx\",\"pvalue\":\"2\"},{\"pname\":\"extraID\",\"pvalue\":\"true\"}],\"output_dis\":[{\"diid\":\"2\",\"interval\": 10,\"delim\" :\",\"}]}',1,'a',NULL),(3,'event3',1,'imsi,cell,timestamp,isLatestSite,tour_area,security_area,acyc_id,live_lac,area_code,work_lac,work_cellid,stat_date,serial_number,age_level,sex,eparchy_id,city_code,pspt_prov_code,pspt_eparchy_id,fee_level,city_name','isLatestSite=\'true\'',3,'{\"props\":[{\"pname\":\"userKeyIdx\",\"pvalue\":\"2\"},{\"pname\":\"extraID\",\"pvalue\":\"true\"}],\"output_dis\":[{\"diid\":\"3\",\"interval\": 0,\"delim\" :\",\"}]}',1,NULL,NULL),(4,'event4',1,'imsi,cell,tour_area,isAccu_tour,security_area,isAccu_security,timestamp','isAccu_tour=\'true\' OR isAccu_security=\'ture\'',4,'{\"props\":[{\"pname\":\"userKeyIdx\",\"pvalue\":\"2\"},{\"pname\":\"extraID\",\"pvalue\":\"true\"}],\"output_dis\":[{\"diid\":\"4\",\"interval\": 0,\"delim\" :\",\"}]}',1,NULL,NULL);
...
INSERT INTO `STREAM_USER` VALUES (1,'ocspadmin','21232f297a57a5a743894a0e4a801fc3','Administrator');
