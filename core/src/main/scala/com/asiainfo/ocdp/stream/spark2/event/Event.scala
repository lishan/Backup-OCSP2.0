package com.asiainfo.ocdp.stream.spark2.event
...
import com.asiainfo.ocdp.stream.spark2.tools.StreamWriterFactory
...
class Event extends Serializable with Logging{
  ...
  def checkEvent(eventDF: DataFrame, uniqKeys: String): Dataset[String] = {
